...
def test_against_manually_classified_data():
    test_data_files = Path("tests/data/ghi_csvs").glob("*.csv")
    ...
    manual_classification = dict(zip(
        manual_classification['date'],
        manual_classification['is_clear']
    ))
