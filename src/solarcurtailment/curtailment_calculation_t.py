...
from tripping_curt_t import *

from vvar_curt_t import *

from vwatt_curt_t import *
from polyfit_t import *
from file_processing_t import *
...
def compute(file_path, data_file, ghi_file):
    ...
    if not size_is_ok:
        ...
        print('Running vvar_curt function')
        data_site, ac_cap, dc_cap, EFF_SYSTEM, inverter = vvar_curt_t.site_organize(c_id, site_details, data, unique_cids)

        print('SKIPPING File processing function')
        ...
        print('check Tripping curtailment')
        ...
        vvar_response, vvar_curt_energy, data_site = vvar_curt_t.check_vvar_curtailment(c_id, date, data_site, ghi, ac_cap, dc_cap, EFF_SYSTEM, is_clear_sky_day)
