...
#             sunset = df.index[-1]
    ...
    def check_tripping_curtailment(self, is_clear_sky_day, c_id, data_site, unique_cids, ac_cap, site_details, date):
        print('Running check_tripping_curtailment')
        ...
        print('Open _circuit_details_for_editing.csv file for sunrise/set times')
        ...
        print('Check for PV sites with very low output and remove them')
        ...
        print('merge keeping only the site_ids in the time series df.')
        ...
        print('Compare using max power output compared with first_ac.')
        ...
        print('Only keep sites that have enough output')
        ...
        # Set up output_df
        print(' Set up output_df')
        output_df = pd.DataFrame()
        output_df.index.name = 't_stamp'

        # Get data for c_id
        print('Get data for c_id')
        ...
        print('Run filter_sunrise_sunset_2 function')
        ...
        print('Flag approximate zeroes (cf < CF_ZERO_APPROX)')
        ...
        print('If the non zero flag count in this row is 2 and in the next row is zero, then set zero_flag to 1 (i.e. remove blip)')
        ...
        print('Set CF to zero where zero flag occurs')
        ...
        print('Run calculate_first_derivative_of_variable function: Get first derivative of cf ')
