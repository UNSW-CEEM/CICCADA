...
def _prepare_cleaned_metrology(
    raw, circuitDetails, power_divisor, start_date, end_date
):
...
def aggregate_site_metrology(
    allData, circuitDetails, site_ids, start_date, end_date, dataset_role
):
