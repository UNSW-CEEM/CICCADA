...
SITE_DAY_EXTRACTION_START = time(6, 0)
SITE_DAY_ANALYSIS_START = time(6, 10)
...
SAPN2022_DAY_WINDOW_SECONDS = 11 * 60 * 60 + 50 * 60

SOLAR_ANALYTICS_DAY_COVERAGE_THRESHOLD = 0.80
SOLAR_ANALYTICS_EXPECTED_TIMESTAMPS = 143
