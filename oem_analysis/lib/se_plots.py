...
def plot_q_categories(summary, figsize=(12, 4.4)):
    ...
    """
    from oem_analysis.lib.se_conformance import Q_CATEGORIES, REDUCED_NONCONF
...
def plot_conformance_dashboard(measures, figsize=(12.5, 12.0)):
    ...
    * row 4 removes system size and reporting volume from row 3, so a fleet that
    ...
    """
    from oem_analysis.lib.se_conformance import MEASURES, Q_CATEGORIES, REDUCED_NONCONF
...
def plot_site_verdicts(verdicts, config=None, figsize=(11.0, 8.0),
    ...
    * **kVArh/kW/h** -- that energy normalised by rating and assessable time.
    ...
    for Volt-Watt.
    """
    from oem_analysis.lib.se_conformance import VERDICT_MEASURES
...
def plot_joint_conformance(breakdown, by, label=None, figsize=(11.0, 4.8)):
    ...
    """
    from oem_analysis.lib.se_conformance import JOINT_CLASSES
...
def plot_sign_flip(flip, figsize=(10, 3.8)):
    ...
    from oem_analysis.lib.se_conformance import Q_CATEGORIES
