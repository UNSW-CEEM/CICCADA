...
This is the ONLY place that writes down:
  ...
  * the sign / unit conventions used to translate OEM telemetry into the
    CICCADA convention,
...
`bms_sa_review.shared.ciccada_config` so that the OEM and Solar Analytics
...
#
# ---------------------------------------------------------------------------
# WHAT OEM ACTUALLY REPORTS -- A MIXED CONVENTION
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# No OEM documentation was available. The convention was established
...
#
# Direction-based conformance remains formally unresolved until OEM confirms
...
#: Reactive power is INSTANTANEOUS var. Unlike OEM Analytics' `energy_reactive`,
